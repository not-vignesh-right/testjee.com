...
// NOTE: For production, move these to environment variables (Vite: VITE_SUPABASE_URL, VITE_SUPABASE_ANON_KEY)
//const SUPABASE_URL = 'https://xpnumkufrnrjensmgost.supabase.co'
