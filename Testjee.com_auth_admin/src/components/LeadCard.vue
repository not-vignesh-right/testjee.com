  ...
  <div class="bg-white rounded-2xl border border-gray-200/80 p-5 hover:shadow-md transition-all animate-fade-in-up group">
    <div class="flex items-start justify-between">
      <div class="flex-1 min-w-0">
        <div class="flex items-center gap-2 mb-1">
          ...
          <span class="flex-shrink-0 text-xs font-semibold px-2 py-0.5 rounded-full bg-gray-100 text-gray-500">
            Lead
          </span>
        </div>
    ...
    <div class="flex items-center gap-2 mt-4 pt-3 border-t border-gray-100">
      <a
        ...
        class="flex-1 flex items-center justify-center gap-1.5 px-4 py-2 bg-green-50 border border-green-200 hover:bg-green-100 text-green-700 text-sm font-semibold rounded-xl transition-all"
      >
      ...
      <button
        ...
        title="Use if you've already verified payment outside the app"
      ...
      <button
        ...
        :disabled="actionLoading"
        class="flex items-center justify-center gap-1.5 px-3 py-2 bg-white border border-gray-200 hover:bg-red-50 hover:border-red-200 text-gray-700 hover:text-red-700 text-sm font-semibold rounded-xl transition-all disabled:opacity-50"
      >
...
const whatsappLink = computed(() => {
  ...
  const text = encodeURIComponent(`Hi ${props.student.student_name}, this is TESTJEE. We noticed you signed up but haven't completed payment yet for your mock test package. Let us know if you need any help!`)
